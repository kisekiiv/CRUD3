...
<div class="card">
  ...
  <div class="card-body">
    <form method="post" action="{{url('diagnosa/'.$txtid)}}">
      @csrf
      @method('PUT')
      <div class="row">
          <div class="col">
        ...
        <div class="row">
          <div class="col">
            ...
            <input type="text" class="form-control form-control-sm @error('txtkode') is-invalid @enderror" list="datalistOptions" id="txtkode" name="txtkode" placeholder="Kode Diagnosa" value="{{ $txtkode }}">
              @error('txtkode')
        ...
        <div class="row">
          <div class="col">
            ...
            <input type="text" class="form-control form-control-sm @error('txtnama') is-invalid @enderror" list="datalistOptions" id="txtnama" name="txtnama" placeholder="Nama Diagnosa" value="{{ $txtnama }}">
              @error('txtnama')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
        ...
        <div class="row">
          <div class="col">
            ...
            <input type="text" class="form-control form-control-sm @error('txtdefinisi') is-invalid @enderror" list="datalistOptions" id="txtdefinisi" name="txtdefinisi" placeholder="Definisi" value="{{ $txtdefinisi }}">
            @error('txtdefinisi')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
        ...
        <div class="row">
          <div class="col">
            ...
            <input type="text" class="form-control form-control-sm @error('txtuser') is-invalid @enderror" list="datalistOptions" id="txtuser" name="txtuser" placeholder="User" value="{{ $txtuser }}">
            <datalist id="datalistOptions">
              <option value="{{ $txtuser }}">
            </datalist>
          </div>
        </div>
        <div class="row">
