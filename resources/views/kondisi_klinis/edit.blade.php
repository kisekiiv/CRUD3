...
<div class="card">
  <div class="card-header">
    Edit Data Kondisi Klinis
  </div>
  <div class="card-body">
    <form method="post" action="{{url('kondisiKlinis/'.$txtid)}}">
      @csrf
      @method('PUT')
      <div class="row">
          <div class="col">
        ...
        <div class="row">
          <div class="col">
            ...
            <input type="text" class="form-control form-control-sm @error('txtkondisi') is-invalid @enderror" list="datalistOptions" id="txtkondisi" name="txtkondisi" placeholder="Kondisi Klinis" value="{{ $txtkondisi }}">
              @error('txtkondisi')
        ...
        <div class="row">
          <div class="col">
            ...
            <input type="text" class="form-control form-control-sm @error('txtkode') is-invalid @enderror" list="datalistOptions" id="txtkode" name="txtkode" placeholder="Kode icd10" value="{{ $txtkode }}">
              @error('txtkode')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
