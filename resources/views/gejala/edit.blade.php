...
<div class="card">
  ...
  <div class="card-body">
    <form method="post" action="{{url('gejala/'.$txtid)}}">
      @csrf
      @method('PUT')
      <div class="row">
          <div class="col">
        ...
        <div class="row">
          <div class="col">
            ...
            <input type="text" class="form-control form-control-sm @error('txtgejala') is-invalid @enderror" list="datalistOptions" id="txtgejala" name="txtgejala" placeholder="Gejala" value="{{ $txtgejala }}">
              @error('txtgejala')
        ...
        <div class="row">
          <div class="col">
            ...
            <input type="text" class="form-control form-control-sm @error('txtsubjek') is-invalid @enderror" list="datalistOptions" id="txtsubjek" name="txtsubjek" placeholder="Jenis Subjektif" value="{{ $txtsubjek }}">
              @error('txtsubjek')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
        ...
        <div class="row">
          <div class="col">
            ...
            <input type="text" class="form-control form-control-sm @error('txtobjek') is-invalid @enderror" list="datalistOptions" id="txtobjek" name="txtobjek" placeholder="Jenis Objektif" value="{{ $txtobjek }}">
            @error('txtobjek')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
        ...
        <div class="row">
          <div class="col">
            <label for="txtloinc" class="col-sm-2 col-form-label">Kode Ioinc</label>
            <input type="text" class="form-control form-control-sm @error('txtloinc') is-invalid @enderror" list="datalistOptions" id="txtloinc" name="txtloinc" placeholder="Kode Ioinc" value="{{ $txtloinc }}">
            @error('txtloinc')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
