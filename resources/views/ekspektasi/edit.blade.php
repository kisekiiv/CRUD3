...
<div class="card">
  <div class="card-header">
    Edit Data Ekspektasi
  </div>
  <div class="card-body">
    <form method="post" action="{{url('ekspektasi/'.$txtid)}}">
      @csrf
      @method('PUT')
      <div class="row">
          <div class="col">
        ...
        <div class="row">
          <div class="col">
            ...
            <input type="text" class="form-control form-control-sm @error('txtekspektasi') is-invalid @enderror" list="datalistOptions" id="txtekspektasi" name="txtekspektasi" placeholder="Ekspektasi" value="{{ $txtekspektasi }}">
              @error('txtekspektasi')
