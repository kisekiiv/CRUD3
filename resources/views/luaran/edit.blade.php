...
<div class="card">
  ...
  <div class="card-body">
    <form method="post" action="{{url('luaran/'.$txtid)}}">
      @csrf
      @method('PUT')
      <div class="row">
          <div class="col">
        ...
        <div class="row">
          <div class="col">
            ...
            <input type="text" class="form-control form-control-sm @error('txtluaran') is-invalid @enderror" list="datalistOptions" id="txtluaran" name="txtluaran" placeholder="Luaran" value="{{ $txtluaran }}">
              @error('txtluaran')
        ...
        <div class="row">
          <div class="col">
            ...
            <input type="text" class="form-control form-control-sm @error('txtekspekID') is-invalid @enderror" list="datalistOptions" id="txtekspekID" name="txtekspekID" placeholder="Ekspektasi ID" value="{{ $txtekspekID }}">
              @error('txtekspekID')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
